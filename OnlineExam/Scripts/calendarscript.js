...
$(document).ready(function () {
    ...
    $('#addDialog').dialog({
        ...
        buttons: {
            "Add": function () {
                var hours = addEndDate._d.getUTCHours() - addStartDate._d.getUTCHours();
                if (hours < 3) {
                    ...
                    var eventToAdd = {
                        ...
                        DoctorID: $("#ctl00_ContentPlaceHolder1_hdnDocID").val(),
                    ...
                    alert("One session will not be more than 2 hours.");
                }
            }
        }
    });
